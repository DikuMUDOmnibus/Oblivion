...
void do_heal(CHAR_DATA *ch, char *argument)
{
	...
	send_to_char("  light: cure light wounds      1 gold\n\r",ch);
	send_to_char("  serious: cure serious wounds  2 gold\n\r",ch);
	send_to_char("  critic: cure critical wounds  5 gold\n\r",ch);
	send_to_char("  heal: healing spell	      10 gold\n\r",ch);
	send_to_char("  blind: cure blindness         10 gold\n\r",ch);
	send_to_char("  disease: cure disease         8 gold\n\r",ch);
	send_to_char("  poison:  cure poison	      10 gold\n\r",ch);
	send_to_char("  uncurse: remove curse	      20 gold\n\r",ch);
