...
{ "down",       do_down,        POS_STANDING,    0,  LOG_NEVER, 0 },
	 ...
	 { "channel", do_channel, POS_STANDING, 0, LOG_NORMAL, 1 },
	 ...
	 { "guild",		do_guild,	POS_DEAD,	ML,  LOG_ALWAYS, 1 },
    ...
    { "consider",	do_consider,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
	 ...
	 { "objdump", do_objdump, POS_DEAD, ML, LOG_NORMAL, 1 },
     ...
     */
	 ...
	 { ".",		do_ooc,	POS_SLEEPING,	 0,  LOG_NORMAL, 0 },
    ...
    { "kick",		do_kick,	POS_FIGHTING,	 0,  LOG_NORMAL, 1 },
	 ...
	 { "dinfo", do_dinfo, POS_SLEEPING, 0, LOG_NORMAL, 1 },
	 ...
	 { "moot",     do_moot, POS_DEAD, 0, LOG_ALWAYS, 1 },
         { "panic",     do_panic,       POS_DEAD,        0,  LOG_NEVER,  1 },	 
    ...
    { "setsac",         do_setsac, POS_DEAD, L7, LOG_ALWAYS, 1 },
    ...
    { "imotd",          do_imotd,       POS_DEAD,       IM,  LOG_NORMAL, 1 },
	 ...
	 { "smote",		do_smote,	POS_DEAD,	0,  LOG_NORMAL, 1 },
